...
def get_version(dist: str = "mkdocstrings-cmake") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["mkdocstrings-cmake"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("MKDOCSTRINGS_CMAKE")]]
    return Environment(
